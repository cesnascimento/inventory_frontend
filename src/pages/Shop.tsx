...
export default function Shop() {
    ...
    const getShop = async () => {
        ...
        const res = await Axios.get(SHOP_URL + `?page=${currentPage}&keyword=${search}`,
    ...
    return (
        <>
            <div className="cardMain">
                <div className="headerContent">
                    ...
                    <div className="flex align-center">
                        ...
                        <Button type="primary" onClick={showModal}>Add Shop</Button>
                    </div>
                </div>
            ...
            <Modal title="Add User" visible={isModalVisible} onCancel={closeModal} footer={false}>
                <ShopForm onAddComplete={closeModal} />
            </Modal>
        </>
    )
}
